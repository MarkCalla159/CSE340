...
-- Tables structure for table `inventory`
...
--Query07: Final Project Create Review Table
CREATE TABLE IF NOT EXISTS public.invReview
(
...
--Query08: Create relationship between `reviews`, `inventory` and `account`
ALTER TABLE IF EXISTS public.invReview
